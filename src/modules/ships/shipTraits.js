const defaultStats = {
    cruiser: { 
        ...
        hp: 16, attack: '1d6', armor: 4, speed: 10, crew: [], crewCapacity: [8, 16],
        cargoCapacity: 1000, modCapacity: 4, modules: [], furnishingsCapacity: 2, furnishings: [], inventory: [], capabilities: [], price: 50000,
    },
    mining_ship: { 
        description: 'Outfitted with drills, ore storage, mineral scanners.',
        hp: 10, attack: '1d2', armor: 2, speed: 9, crew: [], crewCapacity: [4, 7],
        cargoCapacity: 1500,  modCapacity: 2, modules: [], furnishingsCapacity: 1, furnishings: [], inventory: [], capabilities: ["Mining"], price: 30000,
    },
    freighter: { 
        description: 'Designed to haul as much cargo as possible.',
        hp: 10, attack: '1d2', armor: 2, speed: 8, crew: [], crewCapacity: [2, 5],
        cargoCapacity: 4000,  modCapacity: 2, modules: [], furnishingsCapacity: 1, furnishings: [], inventory: [], capabilities: [], price: 30000,
    },
    scout: { 
        description: 'Fast and nimble, equipped with probes and advanced scanning hardware',
        hp: 8, attack: '1d2', armor: 2, speed: 14, crew: [], crewCapacity: [2, 4],
        cargoCapacity: 500,  modCapacity: 1, modules: [], inventory: [], furnishingsCapacity: 1, furnishings: [], capabilities: ["Light Scan"], price: 25000,
    },
    science_vessel: {
        description: 'Equipped with state of the art laboraties and facilities to study exotic material and other life.',
        hp: 6, attack: '1d2', armor: 2, speed: 9, crew: [], crewCapacity: [6, 10],
