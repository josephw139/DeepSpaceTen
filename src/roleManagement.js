...
async function updateShipRoles(member, capabilities) {
    const rolesToRemove = ['1301935269305389178', '1301935368664518737', '1301935428160716861', '1301935457436831754']; // Replace with actual role IDs
    ...
    capabilities.forEach(async (capability) => {
        switch (capability) {
            case 'Mining':
                await member.roles.add('1301935269305389178'); // Replace with actual role ID
                break;
            case 'Research':
